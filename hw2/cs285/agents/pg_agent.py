...
class PGAgent(nn.Module):
    ...
    def _estimate_advantage(
        ...
        if self.critic is None:
            ...
            if self.gae_lambda is None:
                ...
                # HINT: append a dummy T+1 value for simpler recursive calculation,避免最后一个值的计算
    ...
    def _discounted_return(self, rewards: Sequence[float]) -> Sequence[float]:
        ...
        discounted_return = [discounted_return] * len(rewards)
    ...
    def _discounted_reward_to_go(self, rewards: Sequence[float]) -> Sequence[float]:
        ...
        for t in range(len(rewards)):
            ...
            for t_prime in range(t, len(rewards)):
                discounted_rewards += rewards[t_prime] * (self.gamma ** (t_prime - t))
            discounted_rewards_to_go.append(discounted_rewards)
